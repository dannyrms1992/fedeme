...
<section class="py-20 px-4" style="background: linear-gradient(to bottom, color-mix(in srgb, var(--color-secondary) 6%, var(--color-bg)), color-mix(in srgb, var(--color-accent) 6%, var(--color-bg)))">
